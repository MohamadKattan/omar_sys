...
class TableTest extends StatefulWidget {
  ...
  @override
  State<TableTest> createState() => TableTestState();
}
...
class TableTestState extends State<TableTest> {
  ...
  List<Widget> _getTitleWidget() {
    return [
      ...
      _getTitleItemWidget('ATTENDABLE', 200, Colors.black),
      TextButton(
        // padding: EdgeInsets.all(0),
        child: _getTitleItemWidget(
      ...
      _getTitleItemWidget('ORDER STATE', 100, Colors.black),
      _getTitleItemWidget('ADDRESS', 200, Colors.black),
      TextButton(
        // padding: EdgeInsets.all(0),
        child: _getTitleItemWidget(
      ...
      _getTitleItemWidget('PAYMENT', 100, Colors.black),
      Container(
        width: 2,
        height: 56,
        color: Colors.white,
      ...
      _getTitleItemWidget('ACTION', 100, Colors.black),
    ];
  }
